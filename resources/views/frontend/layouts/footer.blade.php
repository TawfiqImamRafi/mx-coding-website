                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <div class="d-flex pt-2">
                            <a class="btn btn-outline-light btn-social" href=" {{ $settings ? $settings->twitter : '' }}"><i
                                    class="fab fa-twitter"></i></a>
                            <a class="btn btn-outline-light btn-social"
                                href=" {{ $settings ? $settings->facebook : '' }}"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-outline-light btn-social" href=" {{ $settings ? $settings->youtube : '' }}"><i
                                    class="fab fa-youtube"></i></a>
                            <a class="btn btn-outline-light btn-social"
                                href=" {{ $settings ? $settings->instagram : '' }}"><i class="fab fa-instagram"></i></a>
                            <a class="btn btn-outline-light btn-social"
                                href=" {{ $settings ? $settings->linkedin : '' }}"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
